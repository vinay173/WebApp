    <%@ page language="java" contentType="text/html; charset=ISO-8859-1"
        ...
        <html>
        <head>
        <title>avnhomepage testing</title>
        <style type="text/css">
        body{
        ...
        <h1 style="font-size: medium;color: #4d4d69;">Hi Guest..</h1>
        <h2 style="position: absolute;top: 80px;left: 328px;color: #4d4d69;">WELCOME TO YOUR ACCOUNT OVERVIEW</h2><br>
        <section class="wlp-login-message-content" style="left: 120px;top: 210px;">
        <strong><p style="text-align: center;font-size: 25px;">DIGITAL TV</p></strong>
        ...
        <strong><p style="text-align: center;font-size: 25px;">BROADBAND</p></strong>
        ...
        <strong><p style="text-align: center;font-size: 25px;">REPAIR</p></strong>
        ...
        <strong><p style="text-align: center;font-size: 25px;">PAYMENT</p></strong>
