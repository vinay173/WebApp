    <%@ page language="java" contentType="text/html; charset=ISO-8859-1"
        ...
        <strong>
        <h1 style="color:#968370;font-size: 350%;position:absolute;left:460px;top:80px;">MARS COMMUNICATION</h1></strong>
        <br><br><br>
        <section class="wlp-login-message-content">
        <p><strong>
        <em>
        <span style="color:darkorange">Help Desk</span>
        </em>
        </strong>
        <br><br>
        ...
        <br><br>
        <em>
        <span style="color: orange"> Troubleshooting problems</span>
        </em>
        <p>
        ...
        <em>
        <span style="color: darkorange"> CONTACT US</span>
        </em>
        <br><br>
